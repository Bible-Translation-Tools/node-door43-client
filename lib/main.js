...
const request = require('./request'),
    ...
    padSlug = require('./utils/slug').pad,
    ncp = require('ncp').ncp;
...
function Client(dbPath, resourceDir, opts) {
    ...
    let LANG_NAMES_URL = "https://langnames.bibleineverylanguage.org/langnames.json";
    ...
    const downloadChunks = function(project) {
        ...
        return request.read(project.chunks_url, opts.userAgent)
    ...
    const downloadSourceLanguages = function(project) {
        return request.read(project.lang_catalog, opts.userAgent)
            .then(function(response) {
    ...
    const downloadSourceResources = function(project) {
        return request.read(project.resourceUrl, opts.userAgent)
            .then(function(response) {
    ...
    const updateResources = function(url, onProgress) {
        ...
        return injectGlobalCatalogs()
            .then(function() {
                library.commit();
               return request.read(url, opts.userAgent);
            })
            .then(function(response) {
    ...
    const updateCatalog = function(slug, onProgress) {
        ...
        return injectGlobalCatalogs()
            ...
            .then(function(catalog) {
                ...
                return request.read(catalog.url, opts.userAgent);
            })
            .then(function(response) {
                if(response.status != 200) return Promise.reject(response);
    ...
    /**
     * Changes the default language catalog URL (langnames.json)
     */
    const setLanguageUrl = function(url) {
        LANG_NAMES_URL = url;
        return Promise.resolve();
    };
    ...
    const downloadContainer_Future = function(languageSlug, projectSlug, resourceSlug, progressCallback) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            .then(function(resource) {
                ...
                return request.download(containerFormat.url, tempFile, opts.userAgent, progressCallback);
            })
            .then(function(response) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            .then(function(props) {
                ...
                if(props.resource.translation_words_assignments_url) {
                    return request.read(props.resource.translation_words_assignments_url, opts.userAgent)
